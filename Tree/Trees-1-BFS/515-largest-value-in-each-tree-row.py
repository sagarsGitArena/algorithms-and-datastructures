...
# largest value in each tree row
    def largest_value_in_each_tree_row( self, root : TreeNode):
        ...
        while queue:
            #max_val =  0 # Consider negative values 
            # In negative value scenario this would change to max_val= float("-inf")
            max_val= float("-inf")
...
if __name__ == "__main__":
    ...
    sol = Solution()
    results = sol.largest_value_in_each_tree_row(root)
    print(results)
